											...
											void* context)
{
	...
	{
        printf("SMI RX-CB: len: Chan: %d, LenBytes: %d\n", channel, data_length);
...
//=========================================================================
int caribou_smi_read(caribou_smi_channel_en channel, caribou_smi_sample_complex_int16* buffer, caribou_smi_sample_meta* metadata, size_t length)
{
    return 0;
}

//=========================================================================
int caribou_smi_write(caribou_smi_channel_en channel, caribou_smi_sample_complex_int16* buffer, size_t length)
{
    return 0;
}
