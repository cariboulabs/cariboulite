...
{
    printf("SMI DBG: ErrAccumCnt: %d, ErrorRate: %.4g, bitrate: %.2f Mbps, ReadTail: %d\n", 
                dev->debug_data.error_accum_counter, dev->debug_data.error_rate, dev->debug_data.bitrate, dev->read_tail_len);
